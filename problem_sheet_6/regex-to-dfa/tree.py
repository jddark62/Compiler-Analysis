...
"""
This class is used to convert a regular expression to a syntax tree
and to determine the nullable, firstpos, lastpos and followpos of each node
"""
class SyntaxTree:
    ...
    """
    This method is used to convert a substring to a subtree
    and to push it into the nodestack
